...
import Newsletter from '../shared/Newsletter'; // by me import
// Fetch TourDrtails( for reviews) for Backend API
...
const TourDetails = () => {
    ...
    // Fetch TourDrtails( for reviews) for Backend API(4th part)
    ...
    const submitHandler = async e =>{
        ...
        try {
            ...
            // review dete time age sing in nahi h tb ye notification dega
